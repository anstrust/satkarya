 ...
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfs2guVoUubWwvniR2G0FgaC9mitthara');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453542496749683645110021');
...
define('HTTP_ROOT','http://'.$_SERVER['HTTP_HOST'].'/tarpanam/');
define('BASE_PATH','http://'.$_SERVER['HTTP_HOST'].'/tarpanam/');
