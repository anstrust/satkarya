    ...
    <section class="content-header">
      ...
      <section class="content">
       <div class="row">
           ...
           <a href="<?php echo HTTP_ROOT.'admin/users/award/'?>"  class="btn btn-success btn-sm backbtn" >Back</a>
           </div>
						...
						<table class="table table-bordered table-striped" id="example1">
						    <tbody>
						       <tr>
      						   ...
      						   <td style="width:60%;"><?php  echo $viewNewsfeed['Award']['title']; ?></td>
      						 </tr>
						       ...
						       <!--tr>
								...
								<tr>
      						   ...
      						   <td style="width:60%;">
      						   <img height="125px" width="200px"  src="<?php echo HTTP_ROOT.'img/adminImage/'.@$viewNewsfeed['Award']['image'] ?>">
      						   </td>
      						 </tr>		
							</tbody>
						</table>
