...
<div class="form-box" style="width:95%;"  id="template-box">
	<h4 class="box-title">Add Newsletter Template</h4>   
    <?php echo $this->Session->flash(); ?>
    <form  action="<?php echo HTTP_ROOT?>admin/users/add_news_template" method="POST" id="editTemplate" enctype="multipart/form-data">
    <input type="hidden" class="required" name="data[NewsletterTemplates][id]" value='' />           
        <div class="body bg-gray">
            <div class="form-group title_div">
              Title:<input type="text" class="required form-control title" name="data[NewsletterTemplates][title]" value='' />
            </div>
            <div id='title_id'></div>
            <div class="form-group subject_div">
              Subject:<input type="text" class="required form-control subject"  name="data[NewsletterTemplates][subject]" value='' />
            </div>
            <div id='sub_id'></div>
            <div class="form-group email_div">
               From:<input type="text" class="required form-control from_email" name="data[NewsletterTemplates][from]" value='' />
            </div>
            <div id='email_id'></div>
            ...
            <div class="form-group">
               Description:<textarea id="editor1"  name="data[NewsletterTemplates][description]" rows="45" cols="44" class="required form-control ckeditor"></textarea>
            </div>
            <div id='des_id'></div>
