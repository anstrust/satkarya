...
<aside class="right-side">
    ...
    <div class="pull-right" style="margin-bottom:10px;">
       ...
       <div class="form-box" style="width:95%; margin:30px; "  id="template-box">
            ...
            <h4 class="box-title">Edit Gallery Image</h4>    
			<?php if($myvar = $this->Session->flash()){ ?>
				<div class="response-msg ui-corner-all">
					<?php echo $myvar;?>
				</div>
			<?php } ?>
            <form method="post" action="<?php echo HTTP_ROOT;?>admin/Users/edit_galleryimage" enctype="multipart/form-data" id="newsfeed_content">
            <input type="hidden" name="data[GalleryImage][id]" value="<?php echo @$newsfeed_content['GalleryImage']['id'];?>" >           
                <div class="body bg-gray">
                    <div class="form-group">
                     Title:<input type="text"  class="form-control required" name="data[GalleryImage][title]" value="<?php echo $newsfeed_content['GalleryImage']['title']; ?>" />
                    </div>
                    <!--div class="form-group">
                     ...
                     Image :<input id="image" name="image" type="file"  />                          
                      <div>
							  <img height="200px" width="200px"  src="<?php echo HTTP_ROOT.'img/adminImage/'.@$newsfeed_content['GalleryImage']['image'] ?>"> 
					      </div>                    
					  </div>
