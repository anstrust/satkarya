...
<?php $id = base64_encode(convert_uuencode(@$user_info['FeedBack']['id']));?>
<style type="text/css">
.button{
  padding:8px 20px;
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['FeedBack']['name'];?></td>			
              </tr>
             <!-- <tr>
                <td style="text-align:left; width: 20px;">Last name :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['FeedBack']['lastname'];?></td>			
              </tr>-->
              <tr>
                <td style="text-align:left; width: 20px;">Subject :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['FeedBack']['subject'];?></td>			
              </tr>
              <tr>
                <td style="text-align:left; width: 30px;">Email ID :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['FeedBack']['email'];?></td>			
              </tr>
          <!--    <tr>
                <td style="text-align:left; width: 20px;">Contact Number :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['FeedBack']['phone'];?></td>			
              </tr>  -->
              <tr>
                <td style="text-align:left; width: 20px;">Request Date :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['FeedBack']['date'];?></td>			
              </tr> 
              <tr>
                <td colspan=2 style="text-align:justify; width: 20px;"><strong>Message :</strong><br><br>
                
                <span><?php echo @$user_info['FeedBack']['message'];?></span>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <div class="form-group title_div">
                        To :<input type="text" readonly class="required form-control"  name="to" value='<?php echo @$user_info['FeedBack']['email'];?>' />
                      </div>
                      <div class="form-group title_div">
