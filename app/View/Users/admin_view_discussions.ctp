...
<div class="form-box" style="width:95%; margin:30px;" id="template-box">
	<h4 class="box-title">Discussion Detail</h4>   
    <?php echo $this->Session->flash(); ?>
      
     <!-- /tabs -->
        <div class="tabbable">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#one" data-toggle="tab">Discussion</a></li>
            <li><a href="#two" data-toggle="tab">Discussion-Views</a></li>
            ...
            <div class="tab-pane active" id="one"><br>
								<div class="body bg-gray">
									<table class="table table-bordered table-striped">
										<thead>
											<tr class="info"> 
												<th colspan=2 class="sorting_asc" style="text-align:left;">Discussion Topic Detail Description</th>
											</tr>
									 </thead>
										<tbody>
											<tr>
												<td style="text-align:left; width: 20px;">Discussion Title :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['Discussion']['title'];?> </td>			
											</tr> 
											<tr>
												<td style="text-align:left; width: 20px;">Approval Status :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['Discussion']['status']==1 ? $approved : $pending;?></td>
											</tr> 
											<tr>
												<td style="text-align:left; width: 20px;">Posted on :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['Discussion']['posted_on'];?></td>			
											</tr> 								
											<tr>
												<td colspan=2 style="text-align:justify; width: 20px;"><strong>Discussion Description :</strong><br><br>
												<span><?php echo @$profileInfo['Discussion']['description'];?></span>
												</td>	 
											</tr>            
										</tbody>
									</table>
            ...
            <div class="tab-pane" id="two"><br>
								<div class="body bg-gray">
									<table class="table table-bordered table-striped">
										<thead>
											<tr class="info"> 
												<th colspan=2 class="sorting_asc" style="text-align:left;">Discussion Views Detail Description</th>
											</tr>
									 </thead>
										<tbody>
										<?php if(empty($profileInfo['DiscussionReplies'])) {?>
										
										<?php } else {
											foreach($profileInfo['DiscussionReplies'] as $replies) {?>
										
											<tr>
												<td colspan=2 style="text-align:center; width: 20px;"><h4>Discussion View</h4></td>
											</tr>
											<tr>
