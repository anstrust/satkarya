...
$id = base64_encode(convert_uuencode($profileInfo['Message']['id']));
//pr($id);die;?>
<style type="text/css">
...
<div class="form-box" style="width:95%; margin:30px;" id="template-box">
	<h4 class="box-title">Message Detail</h4>   
    <?php echo $this->Session->flash(); ?>
      
     <!-- /tabs -->
        <div class="tabbable">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#one" data-toggle="tab">Message Info</a></li>
          </ul>
            ...
            <div class="tab-pane active" id="one"><br>
								<div class="body bg-gray">
									<table class="table table-bordered table-striped">
										...
										<tbody>
											<tr>
												<td style="text-align:left; width: 20px;">Title :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['Message']['title'];?> </td>			
											</tr> 
											<tr>
												<td style="text-align:left; width: 20px;">Message :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['Message']['message'];?></td>
											</tr> 
											<tr>
												<td style="text-align:left; width: 20px;">Posted on :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['Message']['date'];?></td>			
											</tr> 								
