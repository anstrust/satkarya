...
<div class="form-box" style="width:95%; margin:30px;"  id="template-box">
	<h4 class="box-title">Add Admission Post</h4>   
    <?php echo $this->Session->flash(); ?>
    <form  action="<?php echo HTTP_ROOT?>admin/users/add_admission" method="POST" id="editTemplate" enctype="multipart/form-data">
    <input type="hidden" class="required" name="data[Admission][id]" value='' />           
        <div class="body bg-gray">
            <div class="form-group title_div">
              Title:<input type="text" class="required form-control cms_title"  name="data[Admission][title]" value='' />
            </div>
            <div id='title'></div>
            <div class="form-group">
               Description:<textarea id='description' name="data[Admission][description]" rows="45" cols="44" class="required form-control ckeditor"></textarea>
            </div>
            <div id='des_id'></div>
