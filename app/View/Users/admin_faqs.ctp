...
<?php echo $this->Session->flash(); ?>
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
      ...
      <a href="<?php echo HTTP_ROOT;?>admin/users/add_faqs" class="btn-success btn-sm backbtn" ><i class="fa fa-lg fa-plus"></i> &nbsp;Add FAQ</a>&nbsp;&nbsp;&nbsp;
			<a href="<?php echo HTTP_ROOT;?>admin/users/dashboard" class="btn-success btn-sm backbtn" >Back</a>
		</div>
	</div><br /><br /><br />
  <h4><strong>Manage FAQs</strong></h4><label>Total FAQs : <span class="all_count"><?php echo count($total_faq);?></span></label>
