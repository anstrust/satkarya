...
<table id="example1" class="table table-bordered table-striped">
    ...
    foreach($total_cms as $cms){?>
      ...
      <td style="text-align:center; width: 400px;"><?php echo $this->Text->truncate(strip_tags($cms['Cms']['description']),150,array('ending'=>'...','exact'=>false));?></td>
