...
<div class="form-box" style="width:95%;"  id="template-box">
	<h4 class="box-title">Add New Country</h4>   
    <?php echo $this->Session->flash(); ?>
    <form  action="<?php echo HTTP_ROOT?>admin/users/add_country" method="POST" id="editTemplate" enctype="multipart/form-data">
    <input type="hidden" class="required" name="data[Sector][id]" value='' />           
        <div class="body bg-gray">
            <div class="form-group title_div">
              Country Name:<input type="text" class="required form-control title" name="data[Country][country_name]" value='' />
            </div>
            <div id='title_id'></div>
             <div class="form-group title_div">
