...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 welcome_container">
   <hr>
       <h2 class="intro-text text-center"><strong>Blogs Management</strong></h2>
   <hr>
</div><br /><br /><br /><br />
...
<?php echo $this->Session->flash();?>
    ...
    <h4><strong>Blog</strong></h4><label>Total Blog : <span class="all_count"><?php echo count($total_enquiry);?></span></label>
