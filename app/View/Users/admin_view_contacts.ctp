...
<?php $id = base64_encode(convert_uuencode(@$user_info['Contact']['id']));?>
<style type="text/css">
.button{
  padding:8px 20px;
...
<section class="content-header">
		<h1>User Enquiry Description</h1>
</section>  
          ...
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                ...
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['Contact']['fullname'];?></td>			
              </tr>
             <!-- <tr>
                <td style="text-align:left; width: 20px;">Last name :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['Contact']['lastname'];?></td>			
              </tr>-->
              <tr>
                <td style="text-align:left; width: 20px;">Subject :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['Contact']['subject'];?></td>			
              </tr>
              <tr>
                <td style="text-align:left; width: 30px;">Email ID :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['Contact']['email'];?></td>			
              </tr>
              <!--tr>
                <td style="text-align:left; width: 20px;">Contact Number :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['Contact']['phone'];?></td>			
              </tr-->  
              <tr>
                <td style="text-align:left; width: 20px;">Request Date :</td>
                <td style="text-align:left; width: 200px;"><?php echo @$user_info['Contact']['posted_on'];?></td>			
              </tr> 
              <tr>
                <td colspan=2 style="text-align:justify; width: 20px;"><strong>Message :</strong><br><br>
                
                <span><?php echo @$user_info['Contact']['message'];?></span>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                      <div class="form-group title_div">
                        To :<input type="text" readonly class="required form-control"  name="to" value='<?php echo @$user_info['Contact']['email'];?>' />
                      </div>
                      <div class="form-group title_div">
