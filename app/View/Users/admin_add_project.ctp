...
<aside class="right-side">
   ...
   <section class="content">
        ...
        <div class="form-box" style="width:95%; margin:30px; "  id="login-box">
            ...
            <form method="post" action="<?php echo HTTP_ROOT.'admin/users/add_project'; ?>" enctype="multipart/form-data" id="addNews" >
                <div class="body bg-gray">
                    <div class="form-group">
                       Title:<input type="text" class="form-control required" name="data[Project][title]"  placeholder="Tilte"/>
                    </div>
					<div class="form-group">
                       Url:<input type="text" class="form-control required" name="data[Project][link]"  placeholder="Url"/>
                    </div>
                    <div class="form-group">
