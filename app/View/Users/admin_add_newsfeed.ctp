...
<aside class="right-side">
   ...
   <section class="content">
        ...
        <div class="form-box" style="width:700px; margin:30px; "  id="login-box">
            ...
            <form method="post" action="<?php echo HTTP_ROOT.'admin/users/addNewsfeed'; ?>" enctype="multipart/form-data" id="addNews" >
                <div class="body bg-gray">
                    <div class="form-group">
                       Title:<input type="text" class="form-control required" name="data[Newsfeed][title]"  placeholder="News"/>
                    </div>
                    <div class="form-group">
