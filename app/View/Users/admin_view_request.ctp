     ...
     <!-- /tabs -->
        <div class="tabbable">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#one" data-toggle="tab"> Request Info</a></li>
          </ul>
            ...
            <div class="tab-pane active" id="one"><br>
								<div class="body bg-gray">
									<table class="table table-bordered table-striped">
										<thead>
											<tr class="info"> 
												<th colspan=2 class="sorting_asc" style="text-align:left;">Request  Detail Description</th>
											</tr>
									 </thead>
										<tbody>
											<tr>
												<td style="text-align:left; width: 20px;"> Company :</td>
												<td style="text-align:left; width: 200px;">
												<?php if($profileInfo['InventtiRequest']['business_name']=='')
													{
														 echo @$profileInfo['User']['name'];
													 }
													 else
														 {
																echo @$profileInfo['InventtiRequest']['business_name'];
											     		 	}
												 ?> </td>			
											</tr> 
										 
											<tr>
												<td style="text-align:left; width: 20px;">Reason :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['InventtiRequest']['reason'];?></td>			
											</tr> 
										
											<tr>
												<td style="text-align:left; width: 20px;">Message :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['InventtiRequest']['remark'];?></td>			
											</tr> 
											<tr>
												<td style="text-align:left; width: 20px;">Posted on :</td>
												<td style="text-align:left; width: 200px;"><?php echo @$profileInfo['InventtiRequest']['date'];?></td>			
											</tr>								
