					...
					<div class="box-body box table-responsive margin-top-20" >
						<table class="table table-bordered table-striped" id="example1">
							...
							<tr>
								...
								<td style="width:60%;"><?php  echo $viewNewsfeed['Ads']['title']; ?></td>
							</tr>
							<tr>
								<th style="background-color:transparent;width:20%;">Link</th>
								<td style="width:60%;"><?php  echo $viewNewsfeed['Ads']['link']; ?></td>
							</tr>
						   
						       <!--tr>
      						   <th style="background-color:transparent;">Description</th>
      						   <td style="width:60%;"><div class="event-des"><?php  echo $viewNewsfeed['Ads']['description']; ?></div></td>
      						 </tr-->
								<tr>
      						   <th style="background-color:transparent;">Image</th>
      						   <td style="width:60%;">
      						   <img height="125px" width="200px"  src="<?php echo HTTP_ROOT.'img/adminImage/'.@$viewNewsfeed['Ads']['image'] ?>">
      						   </td>
      						 </tr>		
							</tbody>
						</table>
