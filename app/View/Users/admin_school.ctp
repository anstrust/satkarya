...
<?php echo $this->Session->flash();?>
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		<div class="pull-right ">
			<a href="<?php echo HTTP_ROOT.'admin/users/add_school'?>"  class="btn-success btn-sm backbtn" ><i class="fa fa-lg fa-plus"></i> &nbsp;Add School</a>
	...
	<?php echo $this->element('adminElements/school_list');?>
	</div>
</section>
</aside>
