...
<table class="table table-bordered table-striped">
    ...
    foreach($dataInfo as $dataInfo){?>
        <tr>
			...
			<td style="text-align:center; width: 100px;"><strong><?php  echo $dataInfo['User']['profile_viewed']; ?></strong></td>  
			...
			?>
			<a title="" class="tooltips" href="<?php echo HTTP_ROOT;?>admin/users/view_trendig_company/<?php echo $id;?>"><i class="fa fa-lg fa-eye"></i><span>View Detail</span></a>
 	       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
