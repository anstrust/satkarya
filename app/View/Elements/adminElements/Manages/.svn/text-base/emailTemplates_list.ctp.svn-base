	...
	<div id="page-content-wrapper" style="padding:0; margin:0; background:0; box-shadow:0 0 0 0 #fff;">
		<div class="hastable">
			<table id="sort-table"> 
				...
				<tbody> 
					<?php
						//echo '<pre>';print_r($email_temps);die;
						if(!empty($email_temps))
						{
							foreach($email_temps as $pages)
							{ 
						?>
                    <tr>
                        <td><?php echo $pages['EmailTemplate']['title']; ?></td>
                      
                          <td>
                            <?php $pageid = base64_encode(convert_uuencode($pages['EmailTemplate']['id'])); ?>
                          
                            <a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/editEmailTemplates/".$pageid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
