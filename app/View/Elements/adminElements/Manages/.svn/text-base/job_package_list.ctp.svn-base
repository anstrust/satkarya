			...
			<table id="sort-table"> 
				...
				<tbody> 
					<?php
						...
						if(!empty($pkg_detail))
						{
							foreach($pkg_detail as $data)
							{ 
						?>
                    <tr>
                    	<td><?php echo $data['JobPackage']['package_name']; ?></td>
                        <td><?php echo $data['JobPackage']['package_price']; ?></td>
                        
                        
          
                          <td>
                            <?php $pkgid = base64_encode(convert_uuencode($data['JobPackage']['id'])); ?>
                       <!--     <a title="View" class="btn_no_text btn ui-state-default ui-corner-all tooltip" href="<?php echo HTTP_ROOT."admin/Manages/view_faq/".$newsid; ?>">	
                            ...
                            <a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/edit_job_package/".$pkgid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
