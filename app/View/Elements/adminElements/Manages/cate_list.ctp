			...
			<table id="sort-table"> 
				...
				<tbody> 
					<?php
						...
						if(!empty($artCat))
						{
							foreach($artCat as $cat)
							{ 
						?>
                    <tr>
                    	<td><?php echo $cat['ArtCategory']['name']; ?></td>
                                               
                        <td>
                            <?php $artCatid = base64_encode(convert_uuencode($cat['ArtCategory']['id'])); ?>
                                                       
                            <a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/edit_artCat/".$artCatid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
                                <span class="ui-icon ui-icon-pencil"></span>
                            </a>
                            
                              <a title="Delete" class="delRec btn_no_text btn ui-state-default ui-corner-all tooltip" href="<?php echo HTTP_ROOT."admin/Manages/delete_artCat/".$artCatid; ?>" onclick="return confirm('Are you sure you want to delete this Category?');">
