			...
			<table id="sort-table"> 
				...
				<tbody> 
					<?php
						...
						?>
                    <tr>
                    	<td><?php echo $data['PaymentDetail']['name']; ?>	</td>
                        <td><?php echo $data['PaymentDetail']['card_type'];	?>	</td>
                        <td><?php echo $data['PaymentDetail']['paid_amount'];	?>	</td>
                        
                        <td>
                            <?php $newsid = base64_encode(convert_uuencode($data['PaymentDetail']['id'])); ?>
                            <a title="View" class="btn_no_text btn ui-state-default ui-corner-all tooltip" href="<?php echo HTTP_ROOT."admin/Manages/view_payment/".$newsid; ?>">	
