		...
		<div class="hastable">
         <?php /*?><?php echo $this->element('adminElements/table_head'); ?><?php */?>
			<table id="sort-table"> 
				<thead> 
					<tr>
                       <th style="width:auto;">About Site
				...
				<tbody> 
					<?php
						...
						?>
                    <tr>
                    	<td><?php echo $data['Commission']['description'];?></td>
                       
                        <td>
                            <?php $cpyrghtid = base64_encode(convert_uuencode($data['Commission']['id'])); ?>
                            

                               <a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/editcommission/".$cpyrghtid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
