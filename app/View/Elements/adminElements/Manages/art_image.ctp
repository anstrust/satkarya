			...
			<table id="tablesorter"> 
				...
				<tbody> 
                    ...
                    <tr>
						...
						<td><img src="<?php echo HTTP_ROOT.'img/iter_work/thumb/'.$team['ArtWork']['product_imageimage'];?>"/></td>
						 <td>
                           <?php $member_id = base64_encode(convert_uuencode($team['ArtWork']['id'])); ?>
                           
							 <a title="Delete" class="delRec btn_no_text btn ui-state-default ui-corner-all tooltip" href="<?php echo HTTP_ROOT."admin/Members/deleteiternary/".$member_id; ?>" onclick="return confirm('Are you sure you want to delete this record?');">
