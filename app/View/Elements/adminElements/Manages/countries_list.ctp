			...
			<table id="sort-table"> 
				<thead> 
					<tr>
                        ...
                        <th style="width:auto;">Countries</th>
				...
				<tbody> 
					<?php
						...
						?>
                    <tr>
                    	<td><?php echo $data['Country']['country_abb'];?></td>
                        <td><?php echo $data['Country']['name'];?></td>

                          <td>
                            <?php $newsid = base64_encode(convert_uuencode($data['Country']['id'])); ?>
                            
                            <a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/edit_country/".$newsid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
                                <span class="ui-icon ui-icon-pencil"></span>
                            </a>
                            
                              <a title="Delete" class="delRec btn_no_text btn ui-state-default ui-corner-all tooltip" href="<?php echo HTTP_ROOT."admin/Manages/delete_country/".$newsid; ?>" onclick="return confirm('Are you sure you want to delete this Country?');">
