			...
			<table id="sort-table"> 
				...
				<tbody> 
					<?php
						...
						?>
                    <tr>
                    	<td><?php echo $data['Copyright']['description'];?></td>
                       
                        <td>
                            <?php $cpyrghtid = base64_encode(convert_uuencode($data['Copyright']['id'])); ?>
                            

                               <a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/editcopyright/".$cpyrghtid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
