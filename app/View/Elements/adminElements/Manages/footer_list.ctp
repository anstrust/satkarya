			...
			<table id="sort-table"> 
				<thead> 
					<tr>
                        ...
                        <th style="width:auto;">PhoneNo</th>
                        <th style="width:auto;">Email</th>
						<th style="width:auto;">About Site</th>
				...
				<tbody> 
					<?php
						...
						?>
                    <tr>
                    	<td><?php echo $data['ManageFooter']['address'];?></td>
                        <td><?php echo $data['ManageFooter']['phoneno']; ?></td>
                        <td><?php echo $data['ManageFooter']['email']; ?></td>
                        <td><?php echo $data['ManageFooter']['abt_misocket']; ?></td>
                        
          
                          <td>
                            <?php $newsid = base64_encode(convert_uuencode($data['ManageFooter']['id'])); ?>
                            

                               <a title="Edit" href="<?php echo HTTP_ROOT."admin/Manages/editfooter/".$newsid; ?>" class="btn_no_text btn ui-state-default ui-corner-all tooltip">
