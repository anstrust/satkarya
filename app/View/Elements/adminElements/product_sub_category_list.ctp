...
<table class="table table-bordered table-striped">
    <thead>
        <tr class="info"> 
			...
			<!--th class="sorting_asc" style="text-align:center;">Main Category Name</th-->
   ...
   // pr($all_templates);die;?>
        <tr>
			...
			<td style="text-align:left; width: 150px;"><?php echo $all_templates['ProductSubCategory']['sub_category_name']; ?></td>
			<!--td style="text-align:left; width: 150px;"><?php echo $all_templates['ProductCategory']['category_type']; ?></td-->			
			<td style="text-align:left; width: 150px;"><?php echo $all_templates['ProductSubCategory']['created_on']; ?></td>
			<td style="text-align:center; width: 120px;">
				
      <?php $id = base64_encode(convert_uuencode($all_templates['ProductSubCategory']['id'])); 
          if(@$all_templates['ProductSubCategory']['status']==1){
        ...
        ?>
				...
				<a title="" class="tooltips" href="<?php echo HTTP_ROOT."admin/users/edit_product_sub_category/".$id;?>"><i class="fa fa-lg fa-edit"></i><span>Edit</span></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        
        <a title="" class="delRec tooltips" data-model="ProductSubCategory" data-controller="users/product_sub_category/" data-page="<?php echo $this->Paginator->current();?>" id="<?php echo $id;?>" href="javascript:void(0)"><i class="fa fa-lg fa-trash-o"></i><span>Delete</span></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      
        <a title="" class="updateStatus tooltips" data-model="ProductSubCategory" id="<?php echo $id;?>" href="javascript:void(0)"><i class="fa fa-lg <?php echo $toggle_switch;?>"></i><span>Update Status</span></a>  		
      </td>
		</tr>
	<?php $i++; }
}  ?>	 					
