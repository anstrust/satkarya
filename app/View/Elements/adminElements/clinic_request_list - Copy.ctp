...
<table class="table table-bordered table-striped">
    <thead>
        <tr class="info"> 
			...
			<th class="sorting_asc" style="text-align:left;">Company</th>
			<th class="sorting_asc" style="text-align:left;">Reason</th> 
    ...
    //	pr($dataInfo);die;
        ...
        <tr>
			...
			<?php
				if($dataInfo['InventtiRequest']['business_name']=='')
					{
						echo $dataInfo['User']['name'];							
					}
				else
					{
						echo $dataInfo['InventtiRequest']['business_name'];
					}	
			 ?></td> 
			<td style="text-align:left; width: 150px;"><?php echo $dataInfo['InventtiRequest']['reason']; ?></td> 
			<td style="text-align:left; width: 150px;"><?php echo $dataInfo['InventtiRequest']['remark']; ?></td> 
			
			<td style="text-align:center; width: 120px;">
		    <?php $id = base64_encode(convert_uuencode($dataInfo['InventtiRequest']['id']));?>
   	    <a title="" class="tooltips" href="<?php echo HTTP_ROOT;?>admin/users/view_request/<?php echo $id ;?>"><i class="fa fa-lg fa-eye"></i><span>View Detail</span></a>
 	       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         </td>
		</tr>
	<?php $i++; } 
