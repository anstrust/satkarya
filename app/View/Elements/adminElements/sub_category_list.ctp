...
<table class="table table-bordered table-striped">
    ...
    foreach($all_templates as $all_templates){?>
        <tr>
			...
			<td style="text-align:left; width: 150px;"><?php echo $all_templates['SubCategory']['created_on']; ?></td>
			<td style="text-align:center; width: 120px;">
				
      <?php $id = base64_encode(convert_uuencode($all_templates['SubCategory']['id'])); 
          if(@$all_templates['SubCategory']['status']==1){
        ...
        ?>
				...
				<a title="" class="tooltips" href="<?php echo HTTP_ROOT."admin/users/edit_sub_category/".$id;?>"><i class="fa fa-lg fa-edit"></i><span>Edit</span></a>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        
        <a title="" class="delRec tooltips" data-model="SubCategory" data-controller="users/sub_category/" data-page="<?php echo $this->Paginator->current();?>" id="<?php echo $id;?>" href="javascript:void(0)"><i class="fa fa-lg fa-trash-o"></i><span>Delete</span></a>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      
        <a title="" class="updateStatus tooltips" data-model="SubCategory" id="<?php echo $id;?>" href="javascript:void(0)"><i class="fa fa-lg <?php echo $toggle_switch;?>"></i><span>Update Status</span></a>  		
      </td>
		</tr>
	<?php $i++; }
}  ?>	 					
