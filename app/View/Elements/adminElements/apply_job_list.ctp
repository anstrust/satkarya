...
<table class="table table-bordered table-striped">
    <thead>
        <tr class="info"> 
			...
			<th class="sorting_asc" style="text-align:center;">Phone</th>
    ...
    foreach($all_templates as $all_templates){
        ...
        <tr>
			...
			<td style="text-align:left; width: 100px;"><?php echo $all_templates['Career']['name']; ?></td>
			<td style="text-align:left; width: 100px;"><?php echo $all_templates['Career']['phone']; ?></td>
			<td style="text-align:left; width: 100px;"><?php echo $all_templates['Career']['email']; ?></td>
			<td style="text-align:left; width: 100px;"><?php echo $all_templates['Career']['subject']; ?></td>
      ...
      <?php /*$id = base64_encode(convert_uuencode($all_templates['User']['id'])); 
        ...
        ?>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
		  <a title="" class="btn btn-primary"  href="<?php echo HTTP_ROOT.'files/'.$all_templates['Career']['file'];?>">Resume </a>  		
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
