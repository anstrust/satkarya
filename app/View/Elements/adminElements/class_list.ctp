...
<table class="table table-bordered table-striped">
    <thead>
        <tr class="info"> 
			...
			<th class="sorting_asc" style="text-align:center;">Class Name</th>
    ...
    foreach($all_templates as $all_templates){
        ...
        <tr>
			...
			<td style="text-align:left; width: 100px;"><?php echo $all_templates['Class']['class']; ?></td>
      ...
      <?php $id = base64_encode(convert_uuencode($all_templates['Class']['id'])); 
        ...
        ?>
			<a title=""  href="<?php echo HTTP_ROOT."admin/users/worksheet/".$id;?>" class="btn-primary btn-sm"><i class="fa fa-lg fa-file-word-o"></i>&nbsp; Worksheet</a>
